...
//        testClientDyln(cport, timeout, downloadFolder, uploadFolder);
    }
...
//
    ...
    public static void testClientDyln(int cport, int timeout, File downloadFolder, File uploadFolder) {
        Client client = null;
...
//                client.list();
//                client.wrongLoad("tst1.txt", 3);
//                client.remove("test.txt");
//                client.store(new File("tst2.txt"));
//                client.list(
//                );
